...
/*STRUCTS*/
/**
 * struct ListNode - simple linked list
 * @num: number
 * @str: a string
...
/**
 * struct InfoNode - simulated arguments for a function pointer,
 * @arg: string holds arguments
 * @argv: array of strings from arg
 * @path: current command path string
 * @argc: arguments count
 * @lines: number of errors
 * @error_code: exit() error code
 ...
 * @env_changed: a flag for environ changes
 * @status: status of the most recent executed command
 * @sep_buff: pointer to sep_buff
 * @sep_buff_kind: the type of command buffer (CMD_type ||, &&, ;)
 * @fd_read: file descriptor
 * @hist_lines: history number of lines
 */
